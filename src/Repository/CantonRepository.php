...
/**
 * @extends ServiceEntityRepository<Canton>
 *
...
class CantonRepository extends ServiceEntityRepository
{
    ...
    public function save(Canton $entity, bool $flush = false): void
    {
    ...
    public function remove(Canton $entity, bool $flush = false): void
    {
