 ...
 */
final class Version20221107091612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE region (id INT AUTO_INCREMENT NOT NULL, re_nom_fr VARCHAR(23) DEFAULT NULL, re_nom_nl VARCHAR(16) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE regions (id_region INT AUTO_INCREMENT NOT NULL, re_nom_fr VARCHAR(23) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_general_ci`, re_nom_nl VARCHAR(16) CHARACTER SET utf8mb3 DEFAULT NULL COLLATE `utf8mb3_general_ci`, PRIMARY KEY(id_region)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE resultats (id_resultat INT AUTO_INCREMENT NOT NULL, nombre_bulletin INT DEFAULT NULL, pourcentage DOUBLE PRECISION DEFAULT NULL, nombre_inscrit INT DEFAULT NULL, nombre_siege INT DEFAULT NULL, fk_parti INT NOT NULL, fk_election INT NOT NULL, fk_type_election INT NOT NULL, fk_commune INT DEFAULT NULL, fk_canton INT DEFAULT NULL, fk_arrondissement INT DEFAULT NULL, fk_provinvce INT DEFAULT NULL, fk_region INT DEFAULT NULL, INDEX resultats_ty (fk_type_election), INDEX resultat_re (fk_region), INDEX resultat_pr (fk_provinvce), INDEX resultat_pa (fk_parti), INDEX resultat_el (fk_election), INDEX resultat_co (fk_commune), INDEX resultat_ar (fk_arrondissement), PRIMARY KEY(id_resultat)) DEFAULT CHARACTER SET utf8mb3 COLLATE `utf8mb3_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
